...
private:
	...
	private:
		HMODULE hModule = 0;
		const wchar_t* systemPath = L"XAudio2_7.dll";
#ifdef _M_X64
		const wchar_t* folderPath = L"XAudio\\XAudio2_7_64.dll";
		const wchar_t* localPath = L"XAudio2_7_64.dll";
#else
		static const wchar_t* folderPath = L"XAudio\\XAudio2_7_32.dll";
		static const wchar_t* localPath = L"XAudio2_7_32.dll";
#endif
	};
public:
	class Channel
